...
const db = wh();
const queryContent = dl(sh(db, "content"), Il("dateCreate", "desc"));
const saveTextContent = (content) => {
  uf(sh(db, "content"), {
    content,
...
const onGetContent = (callback) => cf(queryContent, callback);
const deleteContent = (id2) => of(rh(db, "content", id2));
const getContent = (id2) => Jl(rh(db, "content", id2));
const updateContent = (id2, newFields) => rf(rh(db, "content", id2), newFields);
const ROUTES = {};
...
const Home = () => {
  ...
  const renderContent = (doc) => {
    ...
    li2.setAttribute("data-userid", doc.data().uid);
    contEdit.setAttribute("class", "oculto");
    name2.textContent = user;
    ...
    li2.appendChild(contEdit);
    li2.appendChild(date);
    if (doc.data().uid === auth.currentUser.uid) {
      li2.appendChild(del);
      li2.appendChild(edit);
      li2.appendChild(save);
      li2.appendChild(cancel);
    ...
    del.addEventListener("click", (e) => {
      e.stopPropagation();
      const id2 = e.target.parentElement.getAttribute("data-id");
    ...
    save.addEventListener("click", async (e) => {
      ...
      if (contEdit.value !== null || contEdit.value !== "") {
        await updateContent(id2, { content: contEdit.value });
        cancel.setAttribute("class", "oculto");
        save.setAttribute("class", "oculto");
...
const logo1 = "/assets/hoja.2e8dd2fd.png";
const googleLogo = "data:image/png;base64,";
const Login = () => {
  ...
  homeSectionSubTitle.textContent = "Reg\xEDstrate";
  const buttonGoogle = document.createElement("button");
  buttonGoogle.type = "button";
  buttonGoogle.id = "googleLogin";
  buttonGoogle.textContent = "Inicia sesi\xF3n con Google  ";
  ...
  formSectionSubTitle.textContent = "Inicia Sesi\xF3n";
  const textEmail = document.createElement("p");
  textEmail.id = "textEmail";
  textEmail.textContent = "Correo electr\xF3nico";
  ...
  textPassword.textContent = "Contrase\xF1a";
